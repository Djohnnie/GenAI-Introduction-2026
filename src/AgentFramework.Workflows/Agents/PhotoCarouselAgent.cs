...
internal static class PhotoCarouselAgent
{
    private const string NAME = nameof(PhotoCarouselAgent);
    private const string DESCRIPTION = nameof(PhotoCarouselAgent);
    private const string INSTRUCTIONS = @"
        ...
        ";
    private const string MCP_NAME = "MijnPhotoCarouselMcpClient";
